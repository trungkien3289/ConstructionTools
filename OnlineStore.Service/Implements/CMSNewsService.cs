        ...
        public CMSNewsView GetCMSNewsById(int? newsId)
        {
            ...
            using (var db = new OnlineStoreMVCEntities())
            {
                ...
                return new CMSNewsView
                {
                    ...
                    CoverImageName = news.share_Images != null ? news.share_Images.ImageName: string.Empty,
                    CoverImagePath = news.share_Images != null ? news.share_Images.ImagePath : string.Empty,
                    Title = news.Title,
